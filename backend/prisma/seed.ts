...
const listeningData: MaterialSeed<MCQ>[] = [
    // Grade 3
    {
        chapter: 1, gradeLevel: 3, title: 'Animals',
        questions: [
            { questionText: 'Hewan apakah yang diucapkan? [TTS: cat]', optionA: 'Kucing', optionB: 'Anjing', optionC: 'Burung', correctAnswer: 'A' },
            { questionText: 'Hewan apakah yang diucapkan? [TTS: dog]', optionA: 'Ikan', optionB: 'Anjing', optionC: 'Kelinci', correctAnswer: 'B' },
            { questionText: 'Hewan apakah yang diucapkan? [TTS: bird]', optionA: 'Burung', optionB: 'Bebek', optionC: 'Ular', correctAnswer: 'A' },
            { questionText: 'Hewan apakah yang diucapkan? [TTS: fish]', optionA: 'Kucing', optionB: 'Burung', optionC: 'Ikan', correctAnswer: 'C' },
            { questionText: 'Hewan apakah yang diucapkan? [TTS: monkey]', optionA: 'Monyet', optionB: 'Singa', optionC: 'Gajah', correctAnswer: 'A' },
            { questionText: 'Hewan apakah yang diucapkan? [TTS: elephant]', optionA: 'Jerapah', optionB: 'Harimau', optionC: 'Gajah', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 2, gradeLevel: 3, title: 'Fruits',
        questions: [
            { questionText: 'Buah apakah yang diucapkan? [TTS: apple]', optionA: 'Pisang', optionB: 'Apel', optionC: 'Jeruk', correctAnswer: 'B' },
            { questionText: 'Buah apakah yang diucapkan? [TTS: banana]', optionA: 'Pisang', optionB: 'Semangka', optionC: 'Anggur', correctAnswer: 'A' },
            { questionText: 'Buah apakah yang diucapkan? [TTS: orange]', optionA: 'Jeruk', optionB: 'Mangga', optionC: 'Melon', correctAnswer: 'A' },
            { questionText: 'Buah apakah yang diucapkan? [TTS: watermelon]', optionA: 'Nanas', optionB: 'Semangka', optionC: 'Pepaya', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 3, gradeLevel: 3, title: 'Numbers',
        questions: [
            { questionText: 'Angka berapakah yang diucapkan? [TTS: one]', optionA: '1', optionB: '2', optionC: '3', correctAnswer: 'A' },
            { questionText: 'Angka berapakah yang diucapkan? [TTS: three]', optionA: '2', optionB: '3', optionC: '4', correctAnswer: 'B' },
            { questionText: 'Angka berapakah yang diucapkan? [TTS: five]', optionA: '4', optionB: '5', optionC: '6', correctAnswer: 'B' },
            { questionText: 'Angka berapakah yang diucapkan? [TTS: seven]', optionA: '7', optionB: '8', optionC: '9', correctAnswer: 'A' },
            { questionText: 'Angka berapakah yang diucapkan? [TTS: ten]', optionA: '8', optionB: '9', optionC: '10', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 4, gradeLevel: 3, title: 'Colors',
        questions: [
            { questionText: 'Warna apakah yang diucapkan? [TTS: red]', optionA: 'Biru', optionB: 'Merah', optionC: 'Kuning', correctAnswer: 'B' },
            { questionText: 'Warna apakah yang diucapkan? [TTS: blue]', optionA: 'Hijau', optionB: 'Hitam', optionC: 'Biru', correctAnswer: 'C' },
            { questionText: 'Warna apakah yang diucapkan? [TTS: yellow]', optionA: 'Kuning', optionB: 'Putih', optionC: 'Cokelat', correctAnswer: 'A' },
            { questionText: 'Warna apakah yang diucapkan? [TTS: green]', optionA: 'Merah', optionB: 'Hijau', optionC: 'Ungu', correctAnswer: 'B' },
            { questionText: 'Warna apakah yang diucapkan? [TTS: black]', optionA: 'Hitam', optionB: 'Putih', optionC: 'Abu-abu', correctAnswer: 'A' },
        ],
    },
    {
        chapter: 5, gradeLevel: 3, title: 'Greetings',
        questions: [
            { questionText: 'Apa arti dari sapaan tersebut? [TTS: good morning]', optionA: 'Selamat malam', optionB: 'Selamat pagi', optionC: 'Selamat siang', correctAnswer: 'B' },
            { questionText: 'Apa arti dari sapaan tersebut? [TTS: good night]', optionA: 'Selamat tidur / malam', optionB: 'Selamat sore', optionC: 'Selamat tinggal', correctAnswer: 'A' },
            { questionText: 'Apa arti dari ucapan tersebut? [TTS: thank you]', optionA: 'Sama-sama', optionB: 'Terima kasih', optionC: 'Maaf', correctAnswer: 'B' },
            { questionText: 'Apa arti dari ucapan tersebut? [TTS: sorry]', optionA: 'Maaf', optionB: 'Tolong', optionC: 'Permisi', correctAnswer: 'A' },
            { questionText: 'Apa arti dari sapaan tersebut? [TTS: hello]', optionA: 'Halo', optionB: 'Sampai jumpa', optionC: 'Terima kasih', correctAnswer: 'A' },
        ],
    },
    {
        chapter: 6, gradeLevel: 3, title: 'Body Parts',
        questions: [
            { questionText: 'Bagian tubuh mana yang diucapkan? [TTS: eye]', optionA: 'Hidung', optionB: 'Mata', optionC: 'Telinga', correctAnswer: 'B' },
            { questionText: 'Bagian tubuh mana yang diucapkan? [TTS: nose]', optionA: 'Hidung', optionB: 'Mulut', optionC: 'Gigi', correctAnswer: 'A' },
            { questionText: 'Bagian tubuh mana yang diucapkan? [TTS: ear]', optionA: 'Kepala', optionB: 'Telinga', optionC: 'Tangan', correctAnswer: 'B' },
            { questionText: 'Bagian tubuh mana yang diucapkan? [TTS: mouth]', optionA: 'Kaki', optionB: 'Perut', optionC: 'Mulut', correctAnswer: 'C' },
            { questionText: 'Bagian tubuh mana yang diucapkan? [TTS: hand]', optionA: 'Tangan', optionB: 'Jari', optionC: 'Lengan', correctAnswer: 'A' },
        ],
    },
    // Grade 4
    {
        chapter: 1, gradeLevel: 4, title: 'Daily Routine',
        questions: [
            { questionText: 'Jam berapakah yang diucapkan? [TTS: six o\'clock]', optionA: 'Jam lima', optionB: 'Jam enam', optionC: 'Jam tujuh', correctAnswer: 'B' },
            { questionText: 'Aktivitas apa yang sedang dilakukan? [TTS: brush teeth]', optionA: 'Mandi', optionB: 'Makan', optionC: 'Menggosok gigi', correctAnswer: 'C' },
            { questionText: 'Kegiatan apa yang disebutkan? [TTS: breakfast]', optionA: 'Sarapan', optionB: 'Makan siang', optionC: 'Makan malam', correctAnswer: 'A' },
            { questionText: 'Ke manakah dia pergi? [TTS: go to school]', optionA: 'Ke pasar', optionB: 'Ke sekolah', optionC: 'Ke taman', correctAnswer: 'B' },
            { questionText: 'Jam berapa dia tidur? [TTS: nine o\'clock]', optionA: 'Jam delapan', optionB: 'Jam sembilan', optionC: 'Jam sepuluh', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 2, gradeLevel: 4, title: 'Professions',
        questions: [
            { questionText: 'Apa profesi yang disebutkan? [TTS: teacher]', optionA: 'Guru', optionB: 'Dokter', optionC: 'Polisi', correctAnswer: 'A' },
            { questionText: 'Siapa yang ditolong oleh dokter? [TTS: sick people]', optionA: 'Murid sekolah', optionB: 'Hewan', optionC: 'Orang sakit', correctAnswer: 'C' },
            { questionText: 'Apa yang ditanam oleh petani? [TTS: rice]', optionA: 'Jagung', optionB: 'Padi', optionC: 'Bunga', correctAnswer: 'B' },
            { questionText: 'Siapa yang ditangkap oleh polisi? [TTS: thief]', optionA: 'Pencuri', optionB: 'Dokter', optionC: 'Guru', correctAnswer: 'A' },
            { questionText: 'Di mana koki tersebut memasak? [TTS: in the kitchen]', optionA: 'Di dapur', optionB: 'Di garasi', optionC: 'Di kamar', correctAnswer: 'A' },
        ],
    },
    {
        chapter: 3, gradeLevel: 4, title: 'House',
        questions: [
            { questionText: 'Benda apa yang ada di ruang tamu? [TTS: sofa]', optionA: 'Meja makan', optionB: 'Sofa', optionC: 'Kompor', correctAnswer: 'B' },
            { questionText: 'Di ruangan manakah ibu berada? [TTS: in the kitchen]', optionA: 'Di dapur', optionB: 'Di kamar mandi', optionC: 'Di garasi', correctAnswer: 'A' },
            { questionText: 'Apa yang dilakukan di kamar mandi? [TTS: take a bath]', optionA: 'Tidur', optionB: 'Mandi', optionC: 'Makan', correctAnswer: 'B' },
            { questionText: 'Di manakah letak selimut itu? [TTS: on the bed]', optionA: 'Di lantai', optionB: 'Di atas meja', optionC: 'Di atas kasur', correctAnswer: 'C' },
            { questionText: 'Di manakah letak mobil? [TTS: in the garage]', optionA: 'Di jalan', optionB: 'Di garasi', optionC: 'Di ruang tamu', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 4, gradeLevel: 4, title: 'Clothes',
        questions: [
            { questionText: 'Apa warna kaos yang dipakai? [TTS: red]', optionA: 'Biru', optionB: 'Merah', optionC: 'Kuning', correctAnswer: 'B' },
            { questionText: 'Pakaian apa yang dia pakai? [TTS: skirt]', optionA: 'Rok', optionB: 'Celana panjang', optionC: 'Jaket', correctAnswer: 'A' },
            { questionText: 'Apa warna sepatu yang disebutkan? [TTS: black]', optionA: 'Putih', optionB: 'Cokelat', optionC: 'Hitam', correctAnswer: 'C' },
            { questionText: 'Benda apa yang diminta untuk dipakai? [TTS: hat]', optionA: 'Sepatu', optionB: 'Topi', optionC: 'Kacamata', correctAnswer: 'B' },
            { questionText: 'Pakaian apa yang dipakai saat dingin? [TTS: jacket]', optionA: 'Kaos oblong', optionB: 'Celana pendek', optionC: 'Jaket', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 5, gradeLevel: 4, title: 'Hobbies',
        questions: [
            { questionText: 'Olahraga apa yang dimainkan? [TTS: football]', optionA: 'Bola basket', optionB: 'Sepak bola', optionC: 'Renang', correctAnswer: 'B' },
            { questionText: 'Apa hobi yang disebutkan? [TTS: reading]', optionA: 'Membaca', optionB: 'Bernyanyi', optionC: 'Menari', correctAnswer: 'A' },
            { questionText: 'Olahraga apa yang dia lakukan? [TTS: swimming]', optionA: 'Berlari', optionB: 'Memancing', optionC: 'Berenang', correctAnswer: 'C' },
            { questionText: 'Kendaraan apa yang dinaiki? [TTS: bicycle]', optionA: 'Sepeda', optionB: 'Sepeda motor', optionC: 'Mobil', correctAnswer: 'A' },
            { questionText: 'Apa yang dilakukan Siti? [TTS: singing]', optionA: 'Menari', optionB: 'Melukis', optionC: 'Bernyanyi', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 6, gradeLevel: 4, title: 'Transport',
        questions: [
            { questionText: 'Bagaimana laju kereta api tersebut? [TTS: very fast]', optionA: 'Lambat', optionB: 'Berisik', optionC: 'Sangat cepat', correctAnswer: 'C' },
            { questionText: 'Di manakah pesawat itu terbang? [TTS: in the sky]', optionA: 'Di jalan raya', optionB: 'Di laut', optionC: 'Di langit', correctAnswer: 'C' },
            { questionText: 'Kendaraan apakah yang dibilang besar? [TTS: ship]', optionA: 'Kapal laut', optionB: 'Mobil', optionC: 'Kereta', correctAnswer: 'A' },
            { questionText: 'Kendaraan apa yang dikendarai ayah? [TTS: motorcycle]', optionA: 'Sepeda motor', optionB: 'Mobil', optionC: 'Truk', correctAnswer: 'A' },
            { questionText: 'Kendaraan apa yang dipakai ke sekolah? [TTS: bus]', optionA: 'Taksi', optionB: 'Bus', optionC: 'Kereta', correctAnswer: 'B' },
        ],
    },
    // Grade 5
    {
        chapter: 1, gradeLevel: 5, title: 'Public Places',
        questions: [
            { questionText: 'Di manakah dokter bekerja? [TTS: at the hospital]', optionA: 'Di sekolah', optionB: 'Di rumah sakit', optionC: 'Di pasar', correctAnswer: 'B' },
            { questionText: 'Apa yang dia pinjam dari perpustakaan? [TTS: book]', optionA: 'Buku', optionB: 'Uang', optionC: 'Makanan', correctAnswer: 'A' },
            { questionText: 'Di mana ibu membeli buah? [TTS: supermarket]', optionA: 'Supermarket', optionB: 'Bank', optionC: 'Kantor pos', correctAnswer: 'A' },
            { questionText: 'Apa yang dilakukan ayah di bank? [TTS: saving money]', optionA: 'Meminjam buku', optionB: 'Mengirim surat', optionC: 'Menyimpan uang', correctAnswer: 'C' },
            { questionText: 'Di manakah dia mengirim surat? [TTS: post office]', optionA: 'Kantor pos', optionB: 'Bank', optionC: 'Rumah sakit', correctAnswer: 'A' },
        ],
    },
    {
        chapter: 2, gradeLevel: 5, title: 'Weather',
        questions: [
            { questionText: 'Bagaimana cuaca di luar? [TTS: raining]', optionA: 'Cerah', optionB: 'Hujan', optionC: 'Berangin', correctAnswer: 'B' },
            { questionText: 'Bagaimana cuaca hari ini? [TTS: sunny]', optionA: 'Cerah', optionB: 'Berawan', optionC: 'Berkabut', correctAnswer: 'A' },
            { questionText: 'Bagaimana cuaca hari ini? [TTS: windy]', optionA: 'Panas', optionB: 'Hujan', optionC: 'Berangin', correctAnswer: 'C' },
            { questionText: 'Kapan salju turun? [TTS: winter]', optionA: 'Musim panas', optionB: 'Musim dingin', optionC: 'Musim gugur', correctAnswer: 'B' },
            { questionText: 'Bagaimana keadaan langit? [TTS: cloudy]', optionA: 'Biru cerah', optionB: 'Berawan', optionC: 'Gelap gulita', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 3, gradeLevel: 5, title: 'Food & Drink',
        questions: [
            { questionText: 'Makanan apa yang dia makan? [TTS: fried rice]', optionA: 'Mie goreng', optionB: 'Nasi goreng', optionC: 'Roti bakar', correctAnswer: 'B' },
            { questionText: 'Minuman apa yang dia minum? [TTS: orange juice]', optionA: 'Susu', optionB: 'Jus apel', optionC: 'Jus jeruk', correctAnswer: 'C' },
            { questionText: 'Bagaimana keadaan mie ayam tersebut? [TTS: hot]', optionA: 'Dingin', optionB: 'Panas', optionC: 'Manis', correctAnswer: 'B' },
            { questionText: 'Bagaimana rasa es krim itu? [TTS: sweet]', optionA: 'Manis', optionB: 'Asam', optionC: 'Pahit', correctAnswer: 'A' },
            { questionText: 'Apa yang mereka makan untuk sarapan? [TTS: bread]', optionA: 'Nasi', optionB: 'Telur', optionC: 'Roti', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 4, gradeLevel: 5, title: 'Feelings',
        questions: [
            { questionText: 'Bagaimana perasaannya? [TTS: happy]', optionA: 'Sedih', optionB: 'Bahagia / Senang', optionC: 'Marah', correctAnswer: 'B' },
            { questionText: 'Bagaimana perasaannya? [TTS: sad]', optionA: 'Sedih', optionB: 'Lelah', optionC: 'Takut', correctAnswer: 'A' },
            { questionText: 'Bagaimana perasaan anak laki-laki itu? [TTS: angry]', optionA: 'Terkejut', optionB: 'Senang', optionC: 'Marah', correctAnswer: 'C' },
            { questionText: 'Bagaimana perasaan mereka? [TTS: tired]', optionA: 'Lelah', optionB: 'Lapar', optionC: 'Haus', correctAnswer: 'A' },
            { questionText: 'Apa yang dia rasakan? [TTS: hungry]', optionA: 'Haus', optionB: 'Ngantuk', optionC: 'Lapar', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 5, gradeLevel: 5, title: 'Appearance',
        questions: [
            { questionText: 'Seperti apa rambutnya? [TTS: long]', optionA: 'Pendek', optionB: 'Panjang', optionC: 'Botak', correctAnswer: 'B' },
            { questionText: 'Bagaimana postur tubuh Budi? [TTS: tall]', optionA: 'Pendek', optionB: 'Gemuk', optionC: 'Tinggi', correctAnswer: 'C' },
            { questionText: 'Seperti apa mata anak perempuan itu? [TTS: big]', optionA: 'Kecil', optionB: 'Sipit', optionC: 'Besar', correctAnswer: 'C' },
            { questionText: 'Apa warna rambut kakek? [TTS: white]', optionA: 'Hitam', optionB: 'Putih', optionC: 'Cokelat', correctAnswer: 'B' },
            { questionText: 'Bagaimana keadaan laki-laki tersebut? [TTS: strong]', optionA: 'Kuat', optionB: 'Lemah', optionC: 'Kurus', correctAnswer: 'A' },
        ],
    },
    {
        chapter: 6, gradeLevel: 5, title: 'Daily Chores',
        questions: [
            { questionText: 'Apa yang sedang dia lakukan? [TTS: sweep the floor]', optionA: 'Menyapu lantai', optionB: 'Mengepel lantai', optionC: 'Mencuci baju', correctAnswer: 'A' },
            { questionText: 'Apa yang dicuci oleh kakak? [TTS: dirty dishes]', optionA: 'Baju', optionB: 'Sepatu', optionC: 'Piring kotor', correctAnswer: 'C' },
            { questionText: 'Apa yang sedang dia rapikan? [TTS: bed]', optionA: 'Meja belajar', optionB: 'Tempat tidur', optionC: 'Lemari pakaian', correctAnswer: 'B' },
            { questionText: 'Apa yang mereka siram? [TTS: plants]', optionA: 'Bunga / Tanaman', optionB: 'Jalanan', optionC: 'Mobil', correctAnswer: 'A' },
            { questionText: 'Apa yang dilakukan Doni? [TTS: feed the cat]', optionA: 'Memandikan kucing', optionB: 'Memberi makan kucing', optionC: 'Mengajak kucing bermain', correctAnswer: 'B' },
        ],
    },
    // Grade 6
    {
        chapter: 1, gradeLevel: 6, title: 'Directions',
        questions: [
            { questionText: 'Di manakah letak bank tersebut? [TTS: between the hospital and post office]', optionA: 'Di belakang rumah sakit', optionB: 'Di antara rumah sakit dan kantor pos', optionC: 'Di sebelah sekolah', correctAnswer: 'B' },
            { questionText: 'Apa yang harus dilakukan saat lampu lalu lintas berwarna merah? [TTS: stop]', optionA: 'Berhenti', optionB: 'Jalan terus', optionC: 'Belok kiri', correctAnswer: 'A' },
            { questionText: 'Ke arah mana kita harus berbelok di perempatan? [TTS: right]', optionA: 'Kiri', optionB: 'Kanan', optionC: 'Lurus', correctAnswer: 'B' },
            { questionText: 'Di manakah letak sekolah? [TTS: opposite the park]', optionA: 'Di seberang taman', optionB: 'Di belakang taman', optionC: 'Di samping taman', correctAnswer: 'A' },
            { questionText: 'Apa yang banyak terdapat di kota? [TTS: tall buildings]', optionA: 'Sawah', optionB: 'Pegunungan', optionC: 'Gedung-gedung tinggi', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 2, gradeLevel: 6, title: 'Health',
        questions: [
            { questionText: 'Sakit apa yang sedang dialami oleh Budi? [TTS: stomachache]', optionA: 'Sakit gigi', optionB: 'Sakit perut', optionC: 'Sakit kepala', correctAnswer: 'B' },
            { questionText: 'Ke manakah Siti pergi berobat? [TTS: to the dentist]', optionA: 'Ke dokter gigi', optionB: 'Ke pasar', optionC: 'Ke rumah sakit umum', correctAnswer: 'A' },
            { questionText: 'Berapa kali obat tersebut harus diminum dalam sehari? [TTS: three times]', optionA: 'Satu kali', optionB: 'Dua kali', optionC: 'Tiga kali', correctAnswer: 'C' },
            { questionText: 'Alat kesehatan apa yang disebutkan? [TTS: thermometer]', optionA: 'Stetoskop', optionB: 'Termometer', optionC: 'Jarum suntik', correctAnswer: 'B' },
            { questionText: 'Apa manfaat makan buah-buahan? [TTS: keep our body healthy]', optionA: 'Membuat sakit', optionB: 'Menjaga tubuh tetap sehat', optionC: 'Membuat lelah', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 3, gradeLevel: 6, title: 'Holidays',
        questions: [
            { questionText: 'Ke manakah mereka pergi berlibur? [TTS: to the beach]', optionA: 'Ke gunung', optionB: 'Ke kebun binatang', optionC: 'Ke pantai', correctAnswer: 'C' },
            { questionText: 'Apa yang sedang mereka bangun/dirikan? [TTS: tent]', optionA: 'Meja kayu', optionB: 'Tenda', optionC: 'Rumah pohon', correctAnswer: 'B' },
            { questionText: 'Apa yang mereka lihat saat di museum? [TTS: dinosaur fossils]', optionA: 'Fosil dinosaurus', optionB: 'Hewan hidup', optionC: 'Pemandangan alam', correctAnswer: 'A' },
            { questionText: 'Di manakah gajah itu berada? [TTS: at the zoo]', optionA: 'Di hutan', optionB: 'Di kebun binatang', optionC: 'Di laut', correctAnswer: 'B' },
            { questionText: 'Bagaimana cuaca di gunung tersebut? [TTS: very cold]', optionA: 'Sangat panas', optionB: 'Sangat dingin', optionC: 'Hangat', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 4, gradeLevel: 6, title: 'Animals & Habitats',
        questions: [
            { questionText: 'Bagaimana ciri-ciri fisik singa yang disebutkan? [TTS: very strong]', optionA: 'Lemah', optionB: 'Kecil', optionC: 'Sangat kuat', correctAnswer: 'C' },
            { questionText: 'Di manakah unta dapat bertahan hidup? [TTS: in the desert]', optionA: 'Di gurun pasir', optionB: 'Di lautan', optionC: 'Di gurun pasir', correctAnswer: 'B' },
            { questionText: 'Apa keahlian utama dari penguin? [TTS: swim]', optionA: 'Berenang', optionB: 'Terbang', optionC: 'Berlari cepat', correctAnswer: 'A' },
            { questionText: 'Apa ciri khas tubuh yang dimiliki oleh kanguru? [TTS: pouch]', optionA: 'Sayap besar', optionB: 'Kantung di perut', optionC: 'Tanduk panjang', correctAnswer: 'B' },
            { questionText: 'Bagaimana ukuran tubuh paus biru? [TTS: very big]', optionA: 'Sangat kecil', optionB: 'Sedang', optionC: 'Sangat besar', correctAnswer: 'C' },
        ],
    },
    {
        chapter: 5, gradeLevel: 6, title: 'Personality',
        questions: [
            { questionText: 'Sifat baik seperti apakah yang dimiliki Rina? [TTS: helpful]', optionA: 'Pemalas', optionB: 'Suka menolong', optionC: 'Pemarah', correctAnswer: 'B' },
            { questionText: 'Sifat seperti apakah yang dimiliki Anton? [TTS: smart]', optionA: 'Pintar', optionB: 'Nakal', optionC: 'Bodoh', correctAnswer: 'A' },
            { questionText: 'Apa kebiasaan dari orang yang jujur? [TTS: tell the truth]', optionA: 'Berbohong', optionB: 'Mengatakan kebenaran', optionC: 'Menyembunyikan barang', correctAnswer: 'B' },
        ],
    },
    {
        chapter: 6, gradeLevel: 6, title: 'Materials',
        questions: [
            { questionText: 'Terbuat dari bahan apakah meja tersebut? [TTS: wood]', optionA: 'Plastik', optionB: 'Besi', optionC: 'Kayu', correctAnswer: 'C' },
            { questionText: 'Terbuat dari bahan apakah cincin tersebut? [TTS: gold]', optionA: 'Emas', optionB: 'Perak', optionC: 'Perunggu', correctAnswer: 'A' },
        ],
    },
    {
        chapter: 7, gradeLevel: 6, title: 'Technology',
        questions: [
            { questionText: 'Apa salah satu kegunaan ponsel pintar? [TTS: to call]', optionA: 'Untuk memasak', optionB: 'Untuk menelepon', optionC: 'Untuk mencuci', correctAnswer: 'B' },
            { questionText: 'Perangkat apa yang digunakan untuk mengetik? [TTS: computer]', optionA: 'Komputer', optionB: 'Televisi', optionC: 'Radio', correctAnswer: 'A' },
            { questionText: 'Apa yang sedang dia kirimkan lewat internet? [TTS: email]', optionA: 'Paket barang', optionB: 'Surat elektronik (Email)', optionC: 'Uang tunai', correctAnswer: 'B' },
            { questionText: 'Apa manfaat utama dari internet? [TTS: find information]', optionA: 'Mencari informasi', optionB: 'Membina hubungan', optionC: 'Membuat bingung', correctAnswer: 'B' },
            { questionText: 'Alat apa yang digunakan oleh fotografer? [TTS: camera]', optionA: 'Kamera', optionB: 'Senter', optionC: 'Termometer', correctAnswer: 'A' },
        ],
    },
];
