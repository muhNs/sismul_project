    ...
    <>
      ...
      <main className="pt-24 pb-28 px-margin-mobile max-w-[800px] mx-auto w-full flex-grow flex flex-col items-center justify-center">
        ...
        <div className="w-full grid grid-cols-2 gap-4 mb-8">
          <Card variant="surface" className="p-4 flex flex-col items-center text-center bg-white shadow-[0_4px_0_#e3e2e2]">
            <span className="material-symbols-outlined text-secondary mb-2" style={{ fontVariationSettings: "'FILL' 1", fontSize: "32px" }}>quiz</span>
            <p className="text-xs font-label font-bold text-on-surface-variant uppercase tracking-wider">Total Soal</p>
            <p className="font-display text-xl font-bold text-on-surface">{chapter.totalQuestions}</p>
          </Card>
          <Card variant="surface" className="p-4 flex flex-col items-center text-center bg-white shadow-[0_4px_0_#e3e2e2]">
            <span className="material-symbols-outlined text-tertiary-container mb-2" style={{ fontVariationSettings: "'FILL' 1", fontSize: "32px" }}>schedule</span>
            <p className="text-xs font-label font-bold text-on-surface-variant uppercase tracking-wider">Estimasi</p>
        ...
        <div className="w-full space-y-4 mt-auto">
          <Button onClick={() => router.push("/quiz/arena")} variant="primary">
            Mulai Belajar!
