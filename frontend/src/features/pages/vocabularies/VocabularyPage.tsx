...
import { wordsData } from "@/features/vocabularies/constants/words";
...
export default function VocabularyPage() {
  ...
  const animalWords = filteredWords.filter((w: any) => w.category === "animals");
  const foodWords = filteredWords.filter((w: any) => w.category === "food");
